...
Este repositorio de Github almacena el **análisis integral** de la base de datos correspondiente a los delitos reportados en la Ciudad de Buenos Aires en el período 2019 y 2023. Su objetivo es documentar el proceso completo, desde la exploración inicial hasta los resultados finales, incluyendo visualizaciones, modelos de Machine Learning y la presentación final.
...
La información utilizada para la realización de este trabajo fue obtenida del **Ministerio de Seguridad y Justicia de la Ciudad Autónoma de Buenos Aires**, a través de su portal de datos públicos. Los datos corresponden a registros de delitos reportados entre los años 2019 y 2023.
